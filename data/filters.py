...
# The filtering procedure idea is largely based on the description in McKinnon et al., 2022 (iopscience.iop.org/article/10.1088/1742-6596/2151/1/012005) to which we refer for technical details.
#
###
...
def set_mahal_distance(wt_df, wind_speed_col_name, power_col_name):
    '''
    Sets a filter value flag using Mahalanobis distance and binning (see referenced paper).
